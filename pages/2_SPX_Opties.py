...
df["expiration"] = pd.to_datetime(df["expiration"], utc=True, errors="coerce").dt.date
...
# === Debugging info ===
st.write("🔍 Aantal rijen voor geselecteerde combinatie:", len(df_filtered))
st.write("📅 Unieke peildata:", df_filtered["snapshot_date"].dt.date.unique())
